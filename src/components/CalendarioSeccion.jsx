  ...
  return (
    <section className="calendario-section">
      ...
      <p className="calendario-text">
        “Durante años pensé que controlar mi diabetes era corregir los malos resultados sobre la marcha, simplemente evitar que no se descontrole. Pero aprendí que no es una cuestión sólo de números: se trata de vivir con libertad, tranquilo, con más energía, sin miedo, con más seguridad, sintiéndome bien con mayor confianza, evitando malestares, descompensaciones y fluctuaciones innecesarias <br /><br />
        ...
        Esta transformación sí es posible, y también puede ser la tuya. <br /><br />
